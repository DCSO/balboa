...
ssize_t blb_protocol_encode_input_request( const protocol_input_request_t* i,char* p,size_t p_sz );
ssize_t blb_protocol_encode_entry( const protocol_entry_t* i,char* p,size_t p_sz );
...
ssize_t blb_protocol_encode_query_request( const protocol_query_request_t* q,char* p,size_t p_sz );
